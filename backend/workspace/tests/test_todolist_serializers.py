...
class TodoListSerializerTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.user = User.objects.create_user(
            email="listserializer@example.com", password="testpass123"
        )
        self.project = Project.objects.create(
            title="List Serializer Project", user=self.user
        )
    ...
    def test_renaming_a_list_to_its_own_name_is_allowed(self):
        ...
        serializer = self.get_serializer(data={"name": "Backlog"}, instance=todo_list)
...
class TODOSerializerListFieldTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.user = User.objects.create_user(
            email="todolistfield@example.com", password="testpass123"
        )
        self.project = Project.objects.create(
            title="Todo List Field Project", user=self.user
        )
    ...
    def test_list_of_another_project_rejected(self):
        ...
        foreign_list = TodoList.objects.create(name="Elsewhere", project=other_project)
        serializer = self.get_serializer(
    ...
    def test_list_of_another_user_rejected(self):
        ...
        other_user = User.objects.create_user(
            email="listintruder@example.com", password="testpass123"
        )
        other_project = Project.objects.create(
