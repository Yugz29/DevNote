...
class TODOModelTest(TestCase):
    ...
    def test_create_todo_with_defaults(self):
        ...
        todo = TODO.objects.create(
            title="Test Todo", description="Description Todo", project=self.project
        )
    ...
    def test_todo_status_choices(self):
        ...
        todo = TODO.objects.create(
            title="Test Todo", status="done", project=self.project
        )
    ...
    def test_todo_priority_choices(self):
        ...
        todo = TODO.objects.create(
            title="Test Todo", priority="low", project=self.project
        )
    ...
    def test_todo_str_representation(self):
        ...
        todo = TODO.objects.create(
            title="My First TODO", status="in_progress", project=self.project
        )
