...
class ProjectSerializerTest(TestCase):
    ...
    def get_serializer(self, data=None, instance=None):
        ...
        return ProjectSerializer(data=data, instance=instance, context=context)
    ...
    def test_missing_name(self):
        ...
        data = {"description": "A description for my test project."}
        serializer = self.get_serializer(data=data)
    ...
    def test_name_too_long(self):
        ...
        data = {"title": "A" * 256, "description": "A description for my test project."}
        serializer = self.get_serializer(data=data)
    ...
    def test_empty_description_allowed(self):
        ...
        data = {"title": "My Project Test", "description": ""}
        serializer = self.get_serializer(data=data)
    ...
    def test_title_trimmed(self):
        ...
        data = {"title": "   My Trimmed Project   ", "description": "A description."}
        serializer = self.get_serializer(data=data)
    ...
    def test_duplicate_title_for_same_user(self):
        ...
        data = {"title": "Unique Project", "description": "First project description."}
